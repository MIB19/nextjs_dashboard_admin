...
const App: React.FC = () => {
  ...
  const handleSubmit = () => {
    setLoading(true)
    const res: Response = dispatch(login(user, password))
    Swal.fire({
      position: "center",
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                ...
                <div className="mb-5">
                  {loading ? (
                    <button
                      className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white flex items-center justify-center transition hover:bg-opacity-90"
                    ><FaSpinner className="animate-spin" /></button>
                  ) : (
                    <button
