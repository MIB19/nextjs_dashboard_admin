...
import { RiLayout3Fill, RiLayoutTop2Fill, RiMapPinAddFill } from "react-icons/ri";
import { FaEnvelope } from "react-icons/fa6";
import { BiSolidCarousel, BiGridVertical } from "react-icons/bi";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-65 flex-col overflow-y-hidden bg-[#0D0730] duration-300 ease-linear lg:static lg:translate-x-0 ${
            ...
            <ul className="mb-6 flex flex-col gap-1">
              ...
              <li>
                <Link
                  href=""
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("stepper") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <BiSolidCarousel size={22} />
                  Stepper
                </Link>
              </li>
              {/* <!-- Menu Item Stepper --> */}
